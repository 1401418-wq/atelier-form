...
export function Approach({ locale }: ApproachProps) {
  ...
  return (
    <section id="approach" className="px-6 md:px-12 py-32 border-t border-neutral-200">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          <div className="md:col-span-5">
            <p className="text-xs uppercase tracking-[0.35em] text-neutral-400 mb-8">
              {t.label}
            </p>

            <h2 className="text-5xl md:text-7xl font-light leading-[1.05] tracking-[-0.04em] max-w-xl">
              {t.title}
            </h2>
          </div>
          ...
          <div className="md:col-span-7 md:pt-28">
            <div className="divide-y divide-neutral-200 border-t border-neutral-200">
              {t.items.map((item, index) => (
                <div key={index} className="group grid grid-cols-12 gap-6 py-10">
                  <span className="col-span-2 text-xs text-neutral-500 pt-2">
                    {String(index + 1).padStart(2, "0")}
                  </span>

                  <div className="col-span-10 space-y-3">
                    <h3 className="text-2xl md:text-3xl font-light tracking-[-0.02em] text-neutral-800 transition duration-300 group-hover:translate-x-2">
                      {item.title}
                    </h3>
