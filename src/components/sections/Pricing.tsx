    ...
    plans: [
      ...
      },
      {
        ...
        items: [
          ...
          "Развёртки стен / фронтальные проекции стен",
    ...
    plans: [
      {
        ...
        badge: null as string | null,
        description:
          "For those who need a thoughtful planning solution and a basic spatial concept.",
        items: [
          "Floor plan",
      ...
      },
      {
        ...
        description:
          "Optimal format for comprehensive working project preparation.",
        items: [
          "Everything from sketch project",
          "Socket plan",
          "Lighting plan with switch references",
          "Electrical equipment layout scheme",
          "Ceiling plan",
          "Floor plan / tile layout",
          "Underfloor heating",
          "Engineering systems",
          "Floor detailing",
        ],
      ...
      },
      {
        ...
        badge: null as string | null,
        description:
          "Maximum project depth with visualisation, selection and implementation support.",
        items: [
          "Everything from basic project",
          "Wall elevations / frontal projections",
          "Material selection",
          "Furniture selection",
          "3D visualisation / 3D tour",
          "Author supervision",
        ],
        featured: false,
      },
