        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-16 md:gap-24">
          ...
          <FadeIn>
            <div>
              ...
              <h2 className="section-heading mb-8">{t.contact.subheading}</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-0 divide-y divide-border border-y border-border">
                ...
                <div className="py-6 flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full bg-transparent text-foreground font-display text-xl font-light placeholder:text-muted-light outline-none focus:outline-none border-none"
                    placeholder="—"
                  />
                </div>
                ...
                <div className="py-6 flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-transparent text-foreground font-display text-xl font-light placeholder:text-muted-light outline-none focus:outline-none border-none resize-none"
                    placeholder="—"
                  />
                </div>
                ...
                <div className="pt-8">
                  <button
                    type="submit"
                    disabled={loading}
                    className="group inline-flex items-center gap-3 border border-foreground px-8 py-4 text-xs tracking-[0.15em] uppercase hover:bg-foreground hover:text-background transition-all duration-500 disabled:opacity-40"
                  >
