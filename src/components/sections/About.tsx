...
export function About({ locale }: AboutProps) {
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-start">
          ...
          <FadeIn className="md:col-span-5">
            <p className="text-[11px] tracking-[0.28em] text-muted uppercase mb-5">
              {t.eyebrow}
            </p>
          ...
          <div className="md:col-span-7">
            <FadeIn delay={100}>
              <p className="text-base leading-[1.75] text-[#4A4744] mb-10 md:mb-12">
                {t.description}
              </p>
            </FadeIn>
  ...
  <p className="mb-2 text-[0.75rem] uppercase tracking-[0.22em] text-muted-foreground">
    {value.label}
  </p>
  <p className="text-base leading-[1.6] text-foreground font-light">
    {value.text}
  </p>
</div>
              </FadeIn>
